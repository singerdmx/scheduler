...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &kubeschedulingv1beta1.Job{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &kubeschedulingv1beta1.Job{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=kubescheduling.k8s.io,resources=jobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kubescheduling.k8s.io,resources=jobs/status,verbs=get;update;patch
func (r *ReconcileJob) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Job instance
	instance := &kubeschedulingv1beta1.Job{}
